/***************************************************************************
ETL Final Project: DWClinicReportData_GirumO
Dev: RRoot
Date:2/21/2017
...
ChangeLog: (Who, When, What) 
    ...
    Girum, 03/10/2025, modified the database name for ETL development project
*****************************************************************************************/
Use Master;
go

If Exists (Select * From Sys.databases where Name = 'DWClinicReportDataGirum')
  Begin
   Alter Database DWClinicReportDataGirum set single_user with rollback immediate;
   Drop Database DWClinicReportDataGirum;
  End
go

Create Database DWClinicReportDataGirum;
go
